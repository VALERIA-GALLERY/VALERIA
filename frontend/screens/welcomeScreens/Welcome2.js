...
export default function W2(){
    ...
    return(
        ...
        <View style={styles.container}>
              ...
              <ImageBackground style={styles.nft} source={require("../../assets/1686064178651.png")} resizeMode="cover" >
              {/* <Image  style={styles.logo} source={require('../../assets/qq.png')}></Image> */}
            <Text style={styles.text}>Explore varius contents and contact the  creators </Text>
            <TouchableOpacity style={styles.button2} onPress={()=>navigation.navigate("W3")}>
